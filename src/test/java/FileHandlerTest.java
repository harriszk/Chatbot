...
public class FileHandlerTest {
    ...
    public void testLoadEntriesFromFile() 
    {
        ...
        List<Integer> actual = this.fileHandler.loadChunkFromFile("testLoadingChunksFile.txt");
    ...
    public void testWriteEntriesToFile() 
    {
        ...
        List<Integer> actual = this.fileHandler.loadChunkFromFile(TEST_DIRECTORY + "/test.txt");
